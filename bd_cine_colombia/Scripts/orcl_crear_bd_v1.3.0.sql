...
alter table CINE_SALAS
   drop constraint FK_CINE_SAL_REFERENCE_TEATRO;
...
alter table DISTRIBUCION
   drop constraint FK_DISTRIBU_REFERENCE_FUNCION;

alter table DISTRIBUCION
   drop constraint FK_DISTRIBU_REFERENCE_CINE_SAL;

alter table ESTADO
   drop constraint FK_ESTADO_REFERENCE_PRODUCTO;

alter table ESTADO
   drop constraint FK_ESTADO_REFERENCE_ASIENTO;

alter table ESTADO
   drop constraint FK_ESTADO_REFERENCE_TEATRO;

alter table FACTURA
   drop constraint FK_FACTURA_REFERENCE_RESULTAO;

alter table FUNCION
   drop constraint FK_FUNCION_REFERENCE_DISTRIBU;
...
alter table PRODUCTO
   drop constraint FK_PRODUCTO_REFERENCE_FACTURA;

alter table RESERVA
   drop constraint FK_RESERVA_REFERENCE_CLIENTE;

alter table RESULTAOD_FACTURA
   drop constraint FK_RESULTAO_REFERENCE_RESULTAD;
...
drop table DISTRIBUCION_FILMS cascade constraints;
...
drop table RESULTAOD_FACTURA cascade constraints;
