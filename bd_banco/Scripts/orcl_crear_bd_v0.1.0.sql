...
alter table DEPOSITO
   drop constraint FK_DEPOSITO_REFERENCE_CUENTA_C;

alter table DEPOSITO
   drop constraint FK_DEPOSITO_REFERENCE_CLASE_PR;
...
alter table RETIRO
   drop constraint FK_RETIRO_REFERENCE_CUENTA;

alter table RETIRO
   drop constraint FK_RETIRO_REFERENCE_MONEDA;
...
alter table TRANSACCION
   drop constraint FK_TRANSACC_REFERENCE_CUENTA;
